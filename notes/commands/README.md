...
| [`docker.md`](docker.md) | The shared-kernel demo, first interactive container, **images: pull/ls/inspect/history/rm, tag and push, pull by digest, reproducing a digest, `docker save` OCI layout, `docker diff` for the writable layer**, namespaces and cgroups under the hood | [03-01](../03-containers-with-docker/01-introduction-to-containers.md) · [03-03](../03-containers-with-docker/03-container-images.md) |
