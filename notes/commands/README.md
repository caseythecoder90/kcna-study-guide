...
| [`docker.md`](docker.md) | **The Docker command reference**: images, containers (run flags, lifecycle, exec/logs/inspect), networks, volumes, build, compose, cross-platform notes, plus the Section 3 lab blocks | [03-04](../03-containers-with-docker/04-running-containers.md) |
